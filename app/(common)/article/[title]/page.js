...
import { SectionArticleAdHorizontal } from '@/components/section-article-ad-horizontal'
...
export default async function ArticlePage ({ params }) {
  ...
  return (
    <article className='max-w-[var(--max-width-content)] mx-auto space-y-8'>
      <header className='space-y-4'>
        <h1 className='text-4xl font-bold tracking-tight lg:text-5xl'>
          Breaking News: Major Climate Agreement Reached at International Summit
        </h1>
        <p className='text-xl text-muted-foreground'>
          World leaders have come together to sign a landmark climate agreement
          that sets ambitious targets for reducing global emissions over the
          next decade.
        </p>
      ...
      <div className='prose prose-lg max-w-none'>
        ...
        <ul>
          ...
          <li>
            The establishment of a $100 billion annual fund to assist developing
          ...
          <li>A global carbon pricing mechanism to be implemented by 2025.</li>
        </ul>
        ...
        <p>
          ...
          balanced and fair approach that considers the needs of both developed
          and developing nations."
        </p>

        <p>
          However, some critics argue that the targets, while ambitious, may not
          be sufficient to prevent the worst effects of climate change.
        ...
        <p>
          ...
          that implementing its provisions will require unprecedented levels of
          international cooperation and domestic policy changes. Key challenges
          include:
        </p>
        ...
        <ul>
          ...
          <li>
            Monitoring and enforcing compliance with the agreement's provisions.
          </li>
        </ul>
        ...
        <p>
          ...
          change, the success of the Geneva Climate Pact will ultimately depend
          on the commitment and actions of governments, businesses, and
          individuals around the globe. The next few years will be crucial in
          determining whether this historic agreement can truly turn the tide in
          the fight against global warming.
        </p>
      </div>

      <SectionArticleAdHorizontal />
